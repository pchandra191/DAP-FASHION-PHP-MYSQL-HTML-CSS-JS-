...
<div class="header">
	 <div class="container">
	     <div class="main-header">
			 ...
			 <div class="logo">
                 <h1 style="color:black;"><b><i>DAP FASHIONS</i></b></h1>
			  </div>			  
			 <div class="box_1">				 
				<?php
								if(isset($_SESSION['u_name'])){	
		...
		<ul class="megamenu skyblue">
		 ...
		 <div class="caption">
		 <h1 style="color:black;">DAP FASHIONS</h1>	 
		 <p style="color:black;"><b>TRENDING AND UNIQUE FASHION CLOTHS WITH ENNUMOUROUS COLLECTION FOR WOMEN & MEN</b></p>
	     </div>
		 </div>